...
public class Config
{
  ...
  public static final String RootPath =
    "D:/apache-tomcat-6.0.14/webapps/rubis";
  public static final String HTMLFilesPath = RootPath;
  public static final String DatabaseProperties =
    RootPath + "/WEB-INF/mysql.properties";
  public static final String HibernateProperties =
    RootPath + "/WEB-INF/hibernate.properties";
